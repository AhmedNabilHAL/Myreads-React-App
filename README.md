...
```
git clone https://github.com/AhmedNabilHAL/Myreads-React-App
npm install
```
...
_README insipred from [sarah-maris](https://github.com/sarah-maris/reactnd-project-myreads/blob/master/README.md) README file_